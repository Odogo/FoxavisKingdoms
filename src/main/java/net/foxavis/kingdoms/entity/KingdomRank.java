 ...
 * @author Kyomi
 */
public class KingdomRank implements Describable, KingdomHeld {
	...
	/**
	 * Creates a new, empty rank. This rank will have no permissions, no prefix, and no description.
	 * @param rankId The unique identifier for the rank (unique for each kingdom)
	 * @param name The name of the rank
	 */
	public KingdomRank(final int rankId, @NotNull String name) {
		this.rankId = rankId;
		this.name = name;
